package com.sc.myssm.myspringmvc;

import com.sc.myssm.ioc.BeanFactory;
import com.sc.myssm.util.StringUtil;
...
public class DispatcherServlet extends ViewBaseServlet{
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(servletPath.substring(0,6).equals("pages/")){
            servletPath = servletPath.substring(6);
        }
